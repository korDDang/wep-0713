...
int no=0;
try{
	String sql="select m.custno,m.custname,m.grade,sum(n.price) from member0713 m, money0713 n where m.custno=n.custno group by m.custno,m.custname,m.grade order by sum(n.price) desc";
