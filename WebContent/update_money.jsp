...
try{
	String sql="select pcost,amount,price,pcode,to_char(sdate,'YYYY-MM-DD') from money0713 where custno=? and saleno=?";
...
<tr>
	<th class="th1">단가</th>
		<td> <input type="text" name="pcost" value="<%=pcost%>"></td>
</tr>
<tr>
	<th class="th1">수량</th>
